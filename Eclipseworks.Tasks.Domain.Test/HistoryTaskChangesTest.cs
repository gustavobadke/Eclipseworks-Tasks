...
namespace Eclipseworks.Tasks.Core.Test
{
    public class HistoryTaskChangesTest
    {
        ...
        private static Domain.Entities.Task GetTaskDefault()
        {
            return new Domain.Entities.Task
            {
                ...
                Priority = Domain.Enums.PriorityTask.Low,
        ...
        public void CompareTwoTaskOnlyStatusDifferente()
        {
            ...
            t2.CreatedAt = t1.CreatedAt;
            t2.Deadline = t1.Deadline;
            t2.Status = Domain.Enums.StatusTask.Todo;
        ...
        public void CompareTwoTaskAllsDifferente()
        {
            ...
            var t2 = new Domain.Entities.Task
            {
                Id = Guid.NewGuid(),
                Deadline = DateTime.UtcNow,
